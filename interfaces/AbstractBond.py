...
class AbstractBond(ABC):
    __slots__ = '_nominal', '_horizon', '_day', '_name', '_price', '_count', '_total_cost'
    ...
    def get_total_reward(self, n_days):
        ...
        return self._nominal * self._count + (n_days + self._horizon - self._day) * self._count - self._total_cost
